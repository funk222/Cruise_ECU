...
****** PINOUTS ******
  ...
  VSS to pin 3 via pullup resistor
    ...
    INTERRUPT
  INTERRUPT OUT to pin SafePin Digital D3
...
unsigned char pins[5] = {8, 9, 6, 7, 5};
int buttonstate0 = 0;
...
void setup() {
  ...
  digitalWrite(SafePin, LOW); //default Throttle is not in working status
  digitalWrite(pins[5], HIGH);//can be used as LED pin.
